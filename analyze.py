...
def analyze_image(image_path):
    ...
    response = openai.chat.completions.create(
        model="gpt-4o",
        messages=[
            {"role": "system", "content": "You are an AI that analyzes and describe the content of an image."},
            {"role": "user", "content": [
        ...
        with open(frame, "rb") as image_file:
            ...
            response = openai.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": [{"type": "image_url", "image_url": {"url": f"data:image/png;base64,{encoded_frame}",}}]}
                ]
            )
